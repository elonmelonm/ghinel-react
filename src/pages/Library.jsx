...
export function Library(){
    ...
    <>
        ...
        >
            ...
            >
                <AnimatePresence>
                    {filteredBooks.map((book, index) => (
                        <motion.div 
                            key={book.id} 
                            className="flex flex-col border-[2px] border-brand p-1.5 rounded-xl gap-4 hover:border-brand/80 transition-colors"
                        ...
                        <div className="flex flex-col text-white gap-4">
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                                {Object.keys(book.languages).map((langCode, langIndex) => (
                                    <motion.button 
                                        key={langCode}
                                        ...
                                        transition={{ 
                                            duration: 0.3, 
                                            delay: (index * 0.1) + (langIndex * 0.05) + 0.5
                                        }}
                                        whileHover={{ 
                                            scale: 1.05,
            ...
            <motion.div 
                className="w-full mt-12 border-b border-white"
                initial={{ scaleX: 0 }}
                animate={{ scaleX: 1 }}
